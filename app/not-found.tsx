  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-lightest dark:from-primary-darkest to-white dark:to-primary-dark flex items-center justify-center px-4">
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold text-primary-darkest dark:text-primary-lightest mb-2">404</h1>
        <p className="text-xl text-primary-mediumDark dark:text-primary-light mb-8">Resume not found</p>
        <Link
          href="/"
